...
VAR_SRC_TOKEN=${MIRROR_REPOSITORY_VAR}_SRC_TOKEN

VAR_DEST_REPO=${MIRROR_REPOSITORY_VAR}_DEST_REPO
VAR_DEST_USER=${MIRROR_REPOSITORY_VAR}_DEST_USER
VAR_DEST_TOKEN=${MIRROR_REPOSITORY_VAR}_DEST_TOKEN
